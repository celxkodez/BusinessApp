                  ...
                  <form @submit.prevent="onSubmit($event)">
                    <div class="form-row">
                      <div class="form-group col-md-6">
                        ...
                        <input type="text" class="form-control" v-model="user.firstname" id="inputFirstname4" placeholder="Firstname">
                      </div>
                      <div class="form-group col-md-6">
                        <label for="inputLastname4">Last name</label>
                        <input type="text" class="form-control" v-model="user.lastname" id="inputLastname4" placeholder="Lastname">
                      </div>
                    </div>
                    <div class="form-row">
                      <div class="form-group col-md-6">
                    ...
                    <div class="form-row">
                      <div class="form-group col-md-4">
                        ...
                        <input type="text" class="form-control" v-model="user.username" id="inputusername">
                      </div>
                      <div class="form-group col-md-4">
                      ...
                      <div class="form-group col-md-3">
                        ...
                        <input type="password" class="form-control" v-model="user.cpassword" id="inputcpassword">
                      </div>
                    </div>
